...
import greensev from "@/assets/greensev.png";
import blue from "@/assets/blue.png";
import lipink from "@/assets/lipink.png";
import greensix from "@/assets/greensix.jpg";
import greenti from "@/assets/greenti.jpg";
import deeppi from "@/assets/deeppi.jpg";
import yellow1 from "@/assets/yellow1.jpg";
import yellow2 from "@/assets/yellow2.jpg";
import greensev1 from "@/assets/greensev1.jpg";
import greensev2 from "@/assets/greensev2.jpg";
...
const products = [
  {
    name: "Girleen Dry Cover With Wings Regular",
    desc: "Maximum overnight protection with leak-lock technology.",
    cat: "Night",
    features: ["12 Hours", "Soft Wings", "Extra Long", "Leak Guard"],
    packSizes: ["6 Pads"],
    images: [yellow, yellow1, yellow2],
  },
  {
    name: " Girleen Dry Cover Extra Large",
    desc: "Dry cover for fast absorbency on heavy flow.",
    cat: "Heavy Flow",
    features: ["XL Size", "Fast Absorption", "Soft Wings", "Odour Control"],
    packSizes: ["7 Pads"],
    images: [greensev, greensev1, greensev2],
  },
  {
    name: "Girleen Shakti Dry Cover With Wings Extra Large",
    desc: "Gentle comfort for everyday use.",
    cat: "Regular",
    features: ["Cotton Surface", "Regular Flow", "Breathable", "Comfort Fit"],
    packSizes: ["6 Pads"],
    images: [blue, blue1, blue2],
  },
  {
    name: "Girleen Dry Cover With Wings Regular",
    desc: "Maximum protection for heavy flow.",
    cat: "Heavy Flow",
    features: ["XXXL Size", "Ultra Absorbent", "Leak Protection", "Comfort"],
    packSizes: ["7 Pads"],
    images: [lipink, pink1, pink2],
  },
  {
    name: "Girleen Cottony Extra large",
    desc: "Thin design with powerful protection.",
    cat: "Ultra Thin",
    features: ["Slim", "Flexible", "Dry Feel", "Soft"],
    packSizes: ["6 Pads"],
    images: [greensix, greensev1, greensev2],
  },
  {
    name: "Girleen Dry Cover Super Saver extra large",
    desc: "Daily freshness and comfort.",
    cat: "Daily Care",
    features: ["Fresh", "Breathable", "Soft", "Light"],
    packSizes: ["21 Pads"],
    images: [greenti, greensev1, greensev2],
  },
  {
    name: "Girleen Ultra Thin Extra Large",
    desc: "Designed for post-delivery comfort.",
    cat: "Maternity",
    features: ["Extra Soft", "Super Absorbent", "Large Size", "Comfort"],
    packSizes: ["6 Pads"],
    images: [deeppi, pink1, pink2],
  },
];
...
>
  ...
  onClick={() => {
    ...
    setSelectedPack(p.packSizes[0]);
    setActiveImage(0);
  }}
  className="mt-8 w-full py-4 rounded-2xl text-white font-bold shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl"
  style={{
...
{selectedProduct && (
  <div className="fixed inset-0 z-[999] bg-black/70 flex items-center justify-center p-6">
    <div className="bg-white rounded-[35px] max-w-5xl w-full overflow-hidden relative">

      <button
        onClick={() => setSelectedProduct(null)}
        className="absolute right-5 top-5 z-20 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center"
      >
        <X size={24} />
      </button>
      ...
      <div className="grid lg:grid-cols-2">
        ...
        <div className="relative bg-pink-50 p-10">
          ...
          <button
            ...
            className="absolute left-5 top-1/2 -translate-y-1/2 bg-white rounded-full p-3 shadow-xl"
          >
            <ChevronLeft />
          </button>
          ...
          <button
            onClick={() =>
              setActiveImage(
                (activeImage + 1) % selectedProduct.images.length
              )
            }
            className="absolute right-5 top-1/2 -translate-y-1/2 bg-white rounded-full p-3 shadow-xl"
          >
            <ChevronRight />
          </button>
          ...
          <div className="flex gap-4 justify-center mt-8">
            {selectedProduct.images.map((img: string, i: number) => (
              <img
                ...
                className={`w-20 h-20 rounded-xl object-cover cursor-pointer border-4 ${
                  activeImage === i
                    ? "border-pink-500"
                    : "border-transparent"
                }`}
        ...
        <div className="p-10">
          ...
          <div className="flex gap-3 flex-wrap">
            {selectedProduct.packSizes.map((pack: string) => (
              <button
                key={pack}
          ...
          <h4 className="font-bold mt-10 mb-4">
            Features
          </h4>
