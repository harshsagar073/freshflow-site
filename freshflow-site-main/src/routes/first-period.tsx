...
export const Route = createFileRoute("/first-period")({
  component: FirstPeriodPage,
});
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-8">
              Your
              <span className="text-[#F05A3A]"> First Period</span>
            </h1>

            <p className="text-lg text-gray-600 leading-relaxed">
              Getting your first period is a natural milestone. Knowing what to
              expect can help you feel more prepared, comfortable and confident.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: "🩷",
                title: "It's Normal",
                text: "Every girl experiences her first period differently. There's no perfect age or time."
              },
              {
                icon: "🗓️",
                title: "Know What to Expect",
                text: "Periods usually last 3–7 days and may be irregular during the first few years."
              },
              {
                icon: "✨",
                title: "Be Confident",
                text: "Understanding your body helps you feel comfortable and prepared."
              }
            ].map((card, i) => (
              <motion.div
                key={i}
          ...
          >
            <div className="max-w-4xl mx-auto bg-white/60 backdrop-blur-xl rounded-[40px] p-10 shadow-[0_20px_60px_rgba(236,72,153,0.15)] text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-5">
                Every First Period Is Unique
              </h2>

              <p className="text-gray-600 text-lg leading-relaxed">
                Most girls get their first period between ages 10 and 15.
                Feeling nervous, curious or excited is completely normal.
                Learning about periods helps you feel more prepared and confident.
              </p>
