...
export const Route = createFileRoute("/ what-are-periods")({
  component: WhatArePeriodsPage,
});

function WhatArePeriodsPage() {
  return (
    <>
      <SiteNav />
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Periods are a natural part of growing up. They are a sign that
              your body is developing and preparing for adulthood.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                text: "Periods are a normal and healthy part of the menstrual cycle."
              },
              {
                icon: "🩷",
                title: "Monthly Cycle",
                text: "Most periods happen every 21–35 days and usually last 3–7 days."
              },
              {
                icon: "✨",
                title: "Stay Confident",
                text: "Understanding periods helps you feel prepared and confident."
              }
            ].map((card, i) => (
              <motion.div
                key={i}
          ...
          >
            <div className="max-w-4xl mx-auto bg-white/60 backdrop-blur-xl rounded-[40px] p-10 shadow-[0_20px_60px_rgba(236,72,153,0.15)] text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Every girl experiences periods differently. Learning about your
                body helps you understand the menstrual cycle and feel more
                comfortable during each stage.
              </p>
