...
export const Route = createFileRoute("/Everything Periods")({
  component: EverythingPeriodsPage,
});

function EverythingPeriodsPage() {
  return (
    <>
      <SiteNav />
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-8">
              Understanding
              <span className="text-[#F05A3A]"> Everything Periods</span>
            </h1>

            <p className="text-lg text-gray-600 leading-relaxed">
              Learn about menstrual cycles, period symptoms, hygiene, cramps,
              and everything you need to know to feel informed and confident.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                text: "Understand the different stages of your cycle and what changes to expect."
              },
              {
                icon: "🌷",
                title: "Period Care",
                text: "Discover hygiene tips and products that help you stay comfortable."
              },
              {
                icon: "✨",
                title: "Confidence",
                text: "Knowledge helps you feel more confident and prepared every month."
              }
            ].map((card, i) => (
              <motion.div
                key={i}
          ...
          >
            <div className="max-w-4xl mx-auto bg-white/60 backdrop-blur-xl rounded-[40px] p-10 shadow-[0_20px_60px_rgba(236,72,153,0.15)] text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Understanding periods and your menstrual cycle helps you take
                better care of your health and feel more comfortable throughout
                every stage.
              </p>
