...
export const Route = createFileRoute("/Other Problems")({
  component: OtherProblemPage,
});

function OtherProblemPage() {
  return (
    <>
      <SiteNav />
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-8">
              Other
              <span className="text-[#F05A3A]"> Problems</span>
            </h1>

            <p className="text-lg text-gray-600 leading-relaxed">
              Learn about common menstrual and reproductive health concerns and
              understand when to seek professional advice.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                text: "Cycles may vary due to stress, hormones, diet or lifestyle changes."
              },
              {
                icon: "💗",
                title: "Spotting",
                text: "Light bleeding between periods can happen for many reasons and is often harmless."
              },
              {
                icon: "✨",
                title: "PCOS & Hormones",
                text: "Hormonal imbalances may affect your cycle and overall health."
              }
            ].map((card, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <div className="w-20 h-20 rounded-3xl bg-gradient-to-brfrom-[#F05A3A]/10 to-rose-400 flex items-center justify-center text-4xl shadow-xl mb-6">
                  {card.icon}
                </div>
          ...
          >
            <div className="max-w-4xl mx-auto bg-white/60 backdrop-blur-xl rounded-[40px] p-10 shadow-[0_20px_60px_rgba(236,72,153,0.15)] text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Every body is unique. If you experience severe pain, unusual
                bleeding, or persistent irregularities, consulting a healthcare
                professional can help you better understand your health.
              </p>
